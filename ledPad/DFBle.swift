...
public struct peripheralWithRssi {
    var RSSI: NSNumber
...
public class DFBle:NSObject, CBCentralManagerDelegate, CBPeripheralDelegate {
    ...
    let charUUID :CBUUID = CBUUID(string: "FFE1")
    ...
    public var peripherals :[peripheralWithRssi]!
    ...
    */
    ...
    public func peripheral(peripheral: CBPeripheral, didDiscoverServices error: NSError?) {
        ...
        print("service count: \(peripheral.services)")
        if (peripheral.services?.count > 0) {
            print("service uuid: \((peripheral.services![0] ).UUID.UUIDString)")
        }
        //if (peripheral.services![0] ).UUID.UUIDString == "FFE0" {
        if (peripheral.services![0] ).UUID.UUIDString == self.serviceUUID.UUIDString {
            print("get FFE0")
            myservice = peripheral.services![0]// as? CBService
            peripheral.discoverCharacteristics(nil, forService: peripheral.services![0])// as! CBService)
        }
    }
    ...
    public func peripheral(peripheral: CBPeripheral, didDiscoverCharacteristicsForService service: CBService, error: NSError?) {
        ...
        print("char uuid: \(char.UUID.UUIDString)")
        //if char.UUID.UUIDString == "FFE1" {
        if char.UUID.UUIDString == self.charUUID.UUIDString {
        print("get FFE1")
        mychar = char
